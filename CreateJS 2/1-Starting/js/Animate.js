window.onload = function() {
		...
		function ticker(){
			...
			//bmp.x = centerX + (Math.random() -.5) * 5;
			//bmp.y = centerY + (Math.random()-.5 )* 5;
			...
			//bmp.x = centerX + Math.sin(createjs.Ticker.getTicks()/20)*5;
			//bmp.y = centerY + Math.sin(createjs.Ticker.getTicks()/2)*5;
